...
public class LoopNewsView extends RelativeLayout {
	...
	protected static final String TAG = "LoopNewsView";
	...
	private String[] mTitles = { "为梦想坚持", "我相信我是黑马", "黑马公开课", "Google/IO",
			"轻松1w+" };
	...
	public LoopNewsView(Context context, AttributeSet attrs) {
		...
		//获取点的大小
		mDotSize = a.getDimensionPixelSize(R.styleable.LoopNewsView_dot_size, 5);
		a.recycle();
		init();
	}
	...
	private void init() {
		LayoutInflater.from(getContext())
				.inflate(R.layout.view_loop_news, this);
		initView();
		initDots();
